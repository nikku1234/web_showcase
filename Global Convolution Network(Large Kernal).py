...
class GCN(nn.Module):
    def __init__(self, input_, output_, ks=7):
        super (GCN,self).__init__()
        
        self.conv_l1 = nn.Conv2d(in_channels = input_,out_channels = output_,kernel_size = (ks,1),padding=(ks/2,0))
        self.conv_l2 = nn.Conv2d(in_channels = input_, out_channels = output_, kernel_size = (1,ks), padding= (0,ks/2))

        self.conv_r1 = nn.Conv2d(in_channels = input_, out_channels = output_ , kernel_size = (1,ks), padding=(0,ks/2))
        self.conv_r2 = nn.Conv2d(in_channels = input_ , out_channels = output_ , kernel_size =(1,ks),padding=(ks/2,0))
